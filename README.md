...
- `assistance_drone`: mod base con la entidad drone y su lógica principal.
- `farmer_drone`: addon de agricultura autónoma.
- `path_lighter_drone`: addon para iluminar rutas automáticamente.
- `pickup_dumper`: addon para vaciar inventario en contenedores cercanos.
